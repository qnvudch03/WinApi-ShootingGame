...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
   ...
   RECT WindowSize = { 0, 0, GWinSizeX , GWinSizeY };
   AdjustWindowRect(&WindowSize, WS_OVERLAPPEDWINDOW, true);

   gHwnd = CreateWindowW(szWindowClass, szTitle, WS_OVERLAPPEDWINDOW,
       CW_USEDEFAULT, 0, WindowSize.right - WindowSize.left, WindowSize.bottom - WindowSize.top, nullptr, nullptr, hInstance, nullptr);
